...
interface IERC20 {
    ...
    // Devuelve un valor booleano resultado de la operación indicada
    function transferLoteria(address _client, address _recipient, uint _amount) external returns(bool);
...
contract ERC20Basic is IERC20 {
    ...
    function transferLoteria(address _client, address _recipient, uint _numTokens) public override returns(bool) {
        require(_numTokens <= balances[_client]);

        // Se resta el número de monedas al cliente
